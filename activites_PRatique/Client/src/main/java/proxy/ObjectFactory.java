...
public class ObjectFactory {
    ...
    private static final QName _Compte_QNAME = new QName("http://WS.emsi.ma/", "compte");
    private static final QName _Conversion_QNAME = new QName("http://WS.emsi.ma/", "conversion");
    private static final QName _ConversionResponse_QNAME = new QName("http://WS.emsi.ma/", "conversionResponse");
    private static final QName _GetCompte_QNAME = new QName("http://WS.emsi.ma/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://WS.emsi.ma/", "getCompteResponse");
    private static final QName _GetComptes_QNAME = new QName("http://WS.emsi.ma/", "getComptes");
    private static final QName _GetComptesResponse_QNAME = new QName("http://WS.emsi.ma/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://WS.emsi.ma/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://WS.emsi.ma/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://WS.emsi.ma/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://WS.emsi.ma/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://WS.emsi.ma/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://WS.emsi.ma/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://WS.emsi.ma/", name = "getComptesResponse")
